...
from utils.model.model_utils import create_critic_model, create_token_critic_model
...
def main():
    ...
    if torch.distributed.get_rank() == 0:
        if args.enable_tensorboard:
            ...
            # wandb.init(project="ReMax",name='opt1.3b_rm_240109_bsz128_epoch2_hh_rlhf')
            wandb.init(project="ReMax",name='llama2-13b_rm_hh_rlhf')
        else:
    ...
    if not args.token_level_reward:
